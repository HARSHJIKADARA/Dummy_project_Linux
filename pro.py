...
l_font = pygame.font.SysFont(None, 60)
# Load images
rock_img = pygame.image.load("roock.png")
paper_img = pygame.image.load("pap.png")
scissors_img = pygame.image.load("ses.png")
# Scale images
img_size = (300, 300)
...
def game_loop():
    ...
    while running:
        ...
        if not round_in_progress:
            ...
            scissors_hover = draw_button("Scissors", 550, 450, 200, 100, blue, (100, 100, 255))
